...
class AWSSageMakerEmbedConfig:
    ...
    TOKENIZER_PATH = str(os.environ.get("TOKENIZER_PATH"))
    EMBED_BATCH_SIZE = int(os.environ.get("AWS_SAGEMAKER_EMBED_BATCH_SIZE"))
...
class PostgresConfig:
    ...
    FETCH_BATCH_SIZE = int(os.environ.get("POSTGRES_FETCH_BATCH_SIZE"))
...
class OpenSearchConfig:
    ...
    UPSERT_BATCH_SIZE = int(os.environ.get("OPENSEARCH_UPSERT_BATCH_SIZE"))
