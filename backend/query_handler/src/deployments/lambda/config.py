...
class SearchSimilarProductsConfig:
    DEFAULT_LIMIT = int(os.environ.get("SEARCH_DEFAULT_LIMIT", 10))
    DEFAULT_THRESHOLD = float(os.environ.get("SEARCH_DEFAULT_THRESHOLD", 0.5))
